...
<table cellpadding="0" cellspacing="0" id="dxImagePropertiesForm">
	...
	<tr>
		<td>
			...
			<!--region #AddComboBox-->
			<%--Add a Label and a ComboBox containing CSS class names--%>
			<br />
			<dxe:ASPxLabel ID="lblCssClass" runat="server" AssociatedControlID="cbImgCssClass" Text="CssClass:">
			</dxe:ASPxLabel>
			<div class="captionIndent"></div>
			<dxe:ASPxComboBox ID="cbImgCssClass" runat="server" ValueType="System.String" ClientInstanceName="_dxeImgCssClass" DropDownStyle="DropDown">
				<Items>
					<dxe:ListEditItem Text="Red dotted border" Value="imgRed" />
					<dxe:ListEditItem Text="Green dotted border" Value="imgGreen" />
					<dxe:ListEditItem Text="Blue dotted border" Value="imgBlue" />
				</Items>
			</dxe:ASPxComboBox>
			<!--endregion #AddComboBox-->               
		</td>
	</tr>    
</table>
